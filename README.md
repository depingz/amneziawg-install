...
```bash
curl -O https://raw.githubusercontent.com/depingz/amneziawg-install/main/amneziawg-install.sh
```
```bash
wget https://raw.githubusercontent.com/depingz/amneziawg-install/main/amneziawg-install.sh
```
